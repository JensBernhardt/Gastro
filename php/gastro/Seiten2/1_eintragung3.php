...
// Berechne den übernächsten Monat
$nextMonthTimestamp = strtotime('+2 months', strtotime("$currentYear-$currentMonth-01"));
$nextYear = date('Y', $nextMonthTimestamp);
$nextMonth = date('m', $nextMonthTimestamp);

// Aufruf der Funktion für den übernächsten Monat
...
<form method="POST" action="1_eintragung3.php">
    <h3>Übernächster Monat</h3>
    <div class="calendar-container">
        <div class="calendar">
            <!-- Monatstabelle hier, wie im Originalcode -->
        </div>
    </div>
    <button type="submit" name="submit_over_next_month" class="submit-button">Abgabe</button>
    <button type="submit" name="delete_over_next_month" class="delete-button">Löschen</button>
</form>
