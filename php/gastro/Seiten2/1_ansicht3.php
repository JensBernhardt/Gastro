...
function generateMonthPlan($year, $month) {
    ...
    for ($i = 0; $i < $maxRows; $i++) {
        ...
        for ($j = 0; $j < 7; $j++) {
            ...
            echo "<input type='text' id='greyp' class='checkbox-gray' name='$resultStringall' data-week='$weekIndex' onclick='toggleWeekGray(this, $weekIndex, $j)'>";
            echo "<input type='text' id='greenp' class='checkbox-green' name='$resultStringvegi' data-week='$weekIndex' onclick='toggleWeekGreen(this, $weekIndex, $j)'>";
            echo "</div></td>";
